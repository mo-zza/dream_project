...
class Report():
    ...
    def build_index_id(self):
        item_src = self.email + str(time.time())
    ...
    def report_vio(self, title:str, report_type:str, content:str, datetime:int):
        ...
        try:
            ...
            block = blockchain.mint_nft(self.contract_id, self.nft_type, self.admin_wallet_address, self.admin_wallet_secret, user_wallet_address, 'DIT', token_model)
